<?php global $parent_id;
	...
	<div id="front-page-category-boxes" class="category-boxes container oswald">
			<div class="row">
			  ...
			  <div class="col-md-3 text-center"><span class="cateogry-box-link-span"><a href="<?php echo get_bloginfo('url') ?>/subscribe">Subscribe to PD</a></span></div>
			</div>
	</div>
...
<?php else: ?>
  ...
  <div id="archive-page-category-boxes" class="category-boxes container oswald">
      <div class="row">
        ...
        <div class="col-md-3 text-center"><span class="cateogry-box-link-span"><a class="<?php echo (is_page('subscribe') ? "cateogry-box-link active" : "cateogry-box-link"); ?>" href="<?php echo get_bloginfo('url') ?>/subscribe">Subscribe to PD</a></span></div>
      </div>
  </div>
